		...
		<main className="seccion">
			...
			<div className="carrito" data-transicion style={{animationDelay: "0.4s"}}>
				...
				<>
					...
					<div className="total">
						Total: BS {carrito.reduce((previo, producto) => {return previo + (producto.precio * producto.cantidad)},0)}
					</div>
				</>
				}
				{
				...
				<table className="tabla-carrito" data-transicion style={{animationDelay: "0.4s"}}>
					...
					<tbody>
						...
						<tr className="total-final">
							...
							<td className="precio">
								BS {carrito.reduce((previo, producto) => {return previo + (producto.precio * producto.cantidad)},0)}
							</td>
						</tr>
					</tbody>
				</table>
